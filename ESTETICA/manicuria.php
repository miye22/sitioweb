...
<br>
<span>Tenemos para ofrecerte estos servicios</span>
<br>
<div class="container">
  <div class="row">
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        <img src="manicura/semi.jpg" class="card-img-top img-fluid" alt="Semipermante">
        <div class="card-body">
          <p class="card-text">Esmaltado Semipermante</p>
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        <img src="manicura/kapping.jpg" class="card-img-top img-fluid" alt="kapping">
        <div class="card-body">
          <p class="card-text">Kapping Gel</p>
        </div>
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <div class="card h-100">
        <img src="manicura/esculpidas.jpg" class="card-img-top img-fluid" alt="Esculpidas">
        <div class="card-body">
          <p class="card-text">Uñas Esculpidas en Acrilico</p>
        </div>
      </div>
    </div>
  </div>
...
<span>Lucí unas manos que enamoren </span>
